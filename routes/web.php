...
Route::get('/', 'ContentsController@aboutMe')->name('about_me');
Route::get('/cv/index','CvController@index')->name('cv');
Route::get('/hobies/hobiesindex', 'HobiesController@hobiesIndex')->name('hobies');
Route::get('/contact/index', 'ContactController@index')->name('contact');
Route::get('/portfolio/portfolio', 'PortfolioController@index')->name('portfolio');
